        ...
        content: (
            <>
                ...
                <p className="text-muted-foreground mb-4">
                    ...
                    to light backgrounds using <a href="/" className="text-[hsl(var(--accent-highlight))] hover:underline">Printify Notes</a> — this
    ...
    'cbse-vs-icse-notes-printing': {
        ...
        content: (
            <>
                ...
                <ul className="list-disc list-inside text-muted-foreground mb-6 space-y-2">
                    <li>Use <a href="/" className="text-[hsl(var(--accent-highlight))] hover:underline">Printify Notes</a> to convert any dark-background coaching PDFs — saves 60% ink regardless of board</li>
        ...
        content: (
            <>
                ...
                <ul className="list-disc list-inside text-muted-foreground mb-6 space-y-2">
                    ...
                    <li><strong>Physics Wallah (YouTube):</strong> Complete NEET syllabus covered — download and print notes using <a href="/" className="text-[hsl(var(--accent-highlight))] hover:underline">Printify Notes</a></li>
                ...
                <ul className="list-disc list-inside text-muted-foreground mb-6 space-y-2">
                    <li>Use <a href="/" className="text-[hsl(var(--accent-highlight))] hover:underline">Printify Notes</a> to convert dark coaching PDFs — save 60% on ink</li>
    ...
    'pdf-vs-printed-notes-science': {
        ...
        content: (
            <>
                ...
                <ul className="list-disc list-inside text-muted-foreground mb-6 space-y-2">
                    <li>Use <a href="/" className="text-[hsl(var(--accent-highlight))] hover:underline">Printify Notes</a> to convert dark coaching PDFs — saves 60% on ink</li>
        ...
        content: (
            <>
                ...
                <ul className="list-disc list-inside text-muted-foreground mb-6 space-y-2">
                    ...
                    <li>Use <a href="/" className="text-[hsl(var(--accent-highlight))] hover:underline">Printify Notes</a> to convert dark PDFs before printing — this alone saves more money than any paper choice</li>
