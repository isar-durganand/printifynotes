...
const StepCard = ({ 
  ...
  >
    ...
    <div className="feature-card text-center md:text-left group">
      {/* Icon with glow */}
      <div className="relative inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-secondary mb-6 group-hover:glow-sm transition-shadow duration-300">
        <Icon className="w-7 h-7 text-foreground" />
        <span className="absolute -top-2 -right-2 w-7 h-7 rounded-full bg-glow text-primary-foreground text-xs font-bold flex items-center justify-center">
          {step}
        </span>
      </div>
