...
const socialLinks = [
    { name: 'LinkedIn', icon: LinkedInIcon, url: 'https://www.linkedin.com/in/durganandishar/', color: 'hover:bg-[#0A66C2]' },
    { name: 'Instagram', icon: InstagramIcon, url: 'https://www.instagram.com/durganand.07/', color: 'hover:bg-[#E4405F]' },
    { name: 'GitHub', icon: GitHubIcon, url: 'https://github.com/isar-durganand', color: 'hover:bg-[#333]' },
    { name: 'X', icon: XIcon, url: 'https://x.com/Durganand_07', color: 'hover:bg-black' },
];
